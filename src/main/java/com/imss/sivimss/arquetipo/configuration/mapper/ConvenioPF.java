...
public interface ConvenioPF {
	...
	public Integer consultaRfcRepetido(@Param("idConvenioPf") Integer idConvenioPf,
	...
	public Integer consultaCurpRepetido(@Param("idConvenioPf") Integer idConvenioPf,
			@Param("identificacion") String identificacion);
	...
	@Select("  SELECT  " +
			...
			"")
	public ArrayList<DetalleConvenioPFXPersonaBeneficiarios> consultaDetalleConvenioXPersonaBenficiarios(
			@Param("idConvenioPf") Integer idConvenioPf);
	...
	@Select(" "
			...
			+ "ENF.ID_CONVENIO_PF = SCP.ID_CONVENIO_PF "
			+ "WHERE SCP.ID_CONVENIO_PF > #{idConvenioPf})")
	public ArrayList<DetalleConvenioPFXPersonaBeneficiariosDocs> consultaDetalleConvenioXPersonaBeneficiariosDocs(
			@Param("idConvenioPf") Integer idConvenioPf);
	...
	public ArrayList<DetalleConvenioPFXEmpresaSolicitantes> consultaDetalleConvenioXEmpresaSolicitantes(
			@Param("idConvenioPf") Integer idConvenioPf);
	...
	@Select("SELECT  " +
			...
			"    INNER JOIN SVC_CONTRATANTE CON ON CON.ID_CONTRATANTE = PAQ.ID_CONTRATANTE " +
			"    INNER JOIN SVC_PERSONA PER ON PER.ID_PERSONA = CON.ID_PERSONA  " + // -- persona contratante
			"    INNER JOIN SVT_DOMICILIO DOM ON DOM.ID_DOMICILIO = CON.ID_DOMICILIO  " + // -- domicilio del
																							// contratante
			"    INNER JOIN SVC_PAIS PAI ON PAI.ID_PAIS = PER.ID_PAIS " +
			"    LEFT  JOIN SVC_ESTADO ES ON ES.ID_ESTADO = PER.ID_ESTADO " +
			"    WHERE PF.ID_CONVENIO_PF = #{idConvenioPf} and CON.IND_ACTIVO = 1 )")
	public ArrayList<DetalleConvenioPFXEmpresaBeneficiarios> consultaDetalleConvenioXEmpresaBeneficiarios(
			@Param("idConvenioPf") Integer idConvenioPf);
	...
	@Select("SELECT  " +
			...
			" " +
			"    WHERE PF.ID_CONVENIO_PF = #{idConvenioPf}  and CON.IND_ACTIVO = 1 )")
	public ArrayList<DetalleConvenioPFXEmpresaBeneficiariosDocs> consultaDetalleConvenioXEmpresaBeneficiariosDocs(
			@Param("idConvenioPf") Integer idConvenioPf);
	...
	public String consultaInePDFContratante(@Param("idPaqueteConvenio") Integer idPaqueteConvenio,
			@Param("idContratante") Integer idContratante, @Param("tipoDocumento") Integer tipoDocumento);
	...
	public String consultaRfcPDFContratante(@Param("idPaqueteConvenio") Integer idPaqueteConvenio,
			@Param("idContratante") Integer idContratante, @Param("tipoDocumento") Integer tipoDocumento);
	...
	public String consultaCurpPDFContratante(@Param("idPaqueteConvenio") Integer idPaqueteConvenio,
			@Param("idContratante") Integer idContratante, @Param("tipoDocumento") Integer tipoDocumento);
	...
	public String consultaInePDFBeneficiario(@Param("idPaqueteConvenio") Integer idPaqueteConvenio,
			@Param("idPersona") Integer idPersona, @Param("tipoDocumento") Integer tipoDocumento);
	...
	public String consultaActaPDFBeneficiario(@Param("idPaqueteConvenio") Integer idPaqueteConvenio,
			@Param("idPersona") Integer idPersona, @Param("tipoDocumento") Integer tipoDocumento);
